...
export function AuthShell({ title, subtitle, children, footer }: AuthShellProps) {
  return (
    <main className="relative flex min-h-screen flex-1 items-center justify-center overflow-hidden px-4 py-16">
      ...
      <section className="relative z-10 w-full max-w-md rounded-2xl border border-white/20 bg-slate-950/65 p-7 shadow-2xl shadow-indigo-950/40 backdrop-blur-xl">
        <div className="mb-6">
